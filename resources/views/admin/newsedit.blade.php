                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapse2" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <input type="text" name='newstitle' class="form-control" id="newstitle" value="{{$newsdata['newstitle']}}">
                            </div>
                        </div>
                        <input style="display:none" type="text" name='NewsID' class="form-control" id="newstitle" value="{{$newsdata['NEWSID']}}">
                    </div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        ...
                        <div id="collapse2" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <textarea class="form-control" name='newscontent' rows="20" id="newscontent">{{$newsdata['newscontent']}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div id='preview'>
                                <img style="max-width:400px" src="{{$newsdata['imgurl']}}">
                            </div>
