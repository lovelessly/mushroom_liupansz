    ...
    <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-7">
            ...
            <div class="row userInfo">
                <div class="col-xs-12 col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div id="collapse2" class="panel-collapse collapse in">
							...
							<form id='form_1'>
								<input type="text" name='product_id' style="display: none" value="0"></input>
                ...
                <div class="col-md-4">
                    <input onclick="product_create_submit();" id="" name="singlebutton" class="btn btn-primary" value="保存"></input>
				</div>
</form>
